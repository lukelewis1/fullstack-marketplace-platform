...
To update the list, simply move the X to the next person in the list.  If you are updating the list, and you are currently at the bottom of the list, then updated list will have the first team member checked.
...
- [ ] Luke Lewis (@lewi0454)
- [ ] Group member name (@lear0022)
- [ ] Group member name (@puja0009)