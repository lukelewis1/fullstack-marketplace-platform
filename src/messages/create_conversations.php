...
// current user and friend are parsed through in POST by the msg_script.js
...
// insert new conversation into the db and return a json object withe the conv id so msg_script.js can handle the ui
$stmt = $conn->prepare(
